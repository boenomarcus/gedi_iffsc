"""
Access the LP DAAC Data Pool with Python

Modified Version of "DAACDataDownload.py"

Original files can be found on the bitbucket repository below:
(Originals by Cole Krehbiel - LPDAAC_NASA)
